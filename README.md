...
## Move semantics
### Rvalue references
C++ distinguishes between lvalues and rvalues. This distinction goes back to C, and the idea of an lvalue as one that can appear on the *left*-hand side of an assignment. 
```cpp
