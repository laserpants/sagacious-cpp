...
### RAII
Smart pointers implement the RAII idiom, which is a way of simplifying lifetime management of resources; such as memory, database connections, sockets, or files; by using a stack allocated object that automatically releases the resource when going out of scope. RAII, which stands for *Resource Acquisition Is Initialization*, 
