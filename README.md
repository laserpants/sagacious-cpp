...
## Smart pointers
### RAII
Having raw pointers flying around all over the code makes it more unpredictable and exposes unnecessary low-level details to client code. The RAII idiom is a way of simplifying lifetime management of resources, such as heap memory, database connections, sockets, or files.
