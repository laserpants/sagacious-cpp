...
## Smart pointers
### RAII
The RAII idiom is a way of simplifying lifetime management of resources, such as heap memory, database connections, sockets, or files. Instead of having raw pointers flying around all over the code,  
